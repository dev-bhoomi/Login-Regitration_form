...
#Registration and Login Form with Html,Css and JavaScript

This project features a comprehensive Registration and Login Form implemented using HTML, CSS, and JavaScript. The form allows users to register for an account with their personal details and login securely with their credentials.
## Demo

Insert gif or link to demo

![Alt Text](https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExN3pmaW9qM3p0MmZnOXAzMXoyNmx5ejFnanRtMHR1am14dGtpMThsZCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/i1jyJK5wkstJKnRpCg/source.gif)

## Deployment

[Link to Deployed Application](https://dev-bhoomi.github.io/Login-Regitration_form/)
